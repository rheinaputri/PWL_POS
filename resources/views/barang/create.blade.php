        ...
        <div class="card-body">
            <form action="{{ url('barang') }}" method="POST" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label for="barang_kode" class="col-2 control-label col-form-label">Kode Barang</label>
                    <div class="col-10">
                ...
                <div class="form-group row">
                    <label for="barang_nama" class="col-2 control-label col-form-label">Nama Barang</label>
                    <div class="col-10">
                ...
                <div class="form-group row">
                    <label for="kategori_id" class="col-2 control-label col-form-label">Kategori</label>
                    <div class="col-10">
                ...
                <div class="form-group row">
                    <label for="harga_beli" class="col-2 control-label col-form-label">Harga Beli</label>
                    <div class="col-10">
                ...
                <div class="form-group row">
                    <label for="harga_jual" class="col-2 control-label col-form-label">Harga Jual</label>
                    <div class="col-10">
