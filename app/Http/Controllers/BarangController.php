...
class BarangController extends Controller
{
    ...
    {
        $products = BarangModel::with('kategori')->select('barang_id', 'barang_kode', 'barang_nama', 'kategori_id', 'harga_beli', 'harga_jual');
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return redirect('/barang')->with('error', 'Data barang gagal dihapus karena masih terdapat relasi dengan tabel lain.');
        }
    }
